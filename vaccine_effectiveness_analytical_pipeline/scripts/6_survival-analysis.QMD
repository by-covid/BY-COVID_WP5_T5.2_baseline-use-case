...
tryCatch(
  {
    ...
    ## Adjust hover text
    plot_surv.pl$x$data[[1]]$text = paste0(paste("Time: ",plot_surv.pl$x$data[[1]]$x,"<br>","Survival probability: ", round(plot_surv.pl$x$data[[1]]$y,3),"<br>","Intervention: ",plot_surv.pl$x$data[[1]]$name))
    plot_surv.pl$x$data[[2]]$text = paste0(paste("Time: ",plot_surv.pl$x$data[[2]]$x,"<br>","Survival probability: ", round(plot_surv.pl$x$data[[2]]$y,3),"<br>","Intervention: ",plot_surv.pl$x$data[[2]]$name))
    plot_surv.pl$x$data[[6]]$text = paste0(paste("Time: ",plot_surv.pl$x$data[[6]]$x,"<br>","Survival probability: ", round(plot_surv.pl$x$data[[6]]$y,3),"<br>","Intervention: ",plot_surv.pl$x$data[[6]]$name))
    plot_surv.pl$x$data[[7]]$text = paste0(paste("Time: ",plot_surv.pl$x$data[[7]]$x,"<br>","Survival probability: ", round(plot_surv.pl$x$data[[7]]$y,3),"<br>","Intervention: ",plot_surv.pl$x$data[[7]]$name))
    plot_surv.pl$x$data[[8]]$hovertext = NULL
...
tryCatch(
  {
    ...
    ## Adjust hover text
    plot_cumev.pl$x$data[[1]]$text = paste0(paste("Time: ",plot_cumev.pl$x$data[[1]]$x,"<br>","Survival probability: ", round(plot_cumev.pl$x$data[[1]]$y,3),"<br>","Intervention: ",plot_surv.pl$x$data[[1]]$name))
    plot_cumev.pl$x$data[[2]]$text = paste0(paste("Time: ",plot_cumev.pl$x$data[[2]]$x,"<br>","Survival probability: ", round(plot_cumev.pl$x$data[[2]]$y,3),"<br>","Intervention: ",plot_cumev.pl$x$data[[2]]$name))
    plot_cumev.pl$x$data[[6]]$text = paste0(paste("Time: ",plot_cumev.pl$x$data[[6]]$x,"<br>","Survival probability: ", round(plot_cumev.pl$x$data[[6]]$y,3),"<br>","Intervention: ",plot_cumev.pl$x$data[[6]]$name))
    plot_cumev.pl$x$data[[7]]$text = paste0(paste("Time: ",plot_cumev.pl$x$data[[7]]$x,"<br>","Survival probability: ", round(plot_cumev.pl$x$data[[7]]$y,3),"<br>","Intervention: ",plot_cumev.pl$x$data[[7]]$name))
    plot_cumev.pl$x$data[[8]]$hovertext = NULL
...
tryCatch(
  {
    ...
    surv_fit_vacschedule <- survfit(Surv(time=futime,event=status) ~ fully_vaccinated_bl,  data=df_matched)
    ...
    n_facet <- length(ggsurv.facet.vacschedule.ply$x$data)/8
    ...
    for (i in ((2*n_facet+n_facet+1)+(2*n_facet)):((2*n_facet+n_facet+1)+(4*n_facet)-1)) {
      ggsurv.facet.vacschedule.ply$x$data[[i]]$text = paste0("Time: ",ggsurv.facet.vacschedule.ply$x$data[[i]]$x,"<br>","Survival probability: ", round(ggsurv.facet.vacschedule.ply$x$data[[i]]$y,3),"<br>","Intervention: ",gsub('^\\(|,\\d+\\)$', '', ggsurv.facet.vacschedule.ply$x$data[[i]]$name))
    }  
...
tryCatch(
  {
    ...
    ## Adjust legend label
    # Count number of different vaccination schedules
    n_facet <- length(ggcumev.facet.vacschedule.ply$x$data)/8
    # Show the legend only for the first layer of the group
    ggcumev.facet.vacschedule.ply$x$data[[1]]$showlegend <- TRUE 
    ggcumev.facet.vacschedule.ply$x$data[[1]]$name = paste0("fully_vaccinated_bl=",gsub('^\\(|,\\d+\\)$', '', ggcumev.facet.vacschedule.ply$x$data[[1]]$name))
    for (i in 2:n_facet) {
      ggcumev.facet.vacschedule.ply$x$data[[i]]$showlegend <- FALSE
    }
    ggcumev.facet.vacschedule.ply$x$data[[n_facet+1]]$showlegend <- TRUE 
    ggcumev.facet.vacschedule.ply$x$data[[n_facet+1]]$name = paste0("fully_vaccinated_bl=",gsub('^\\(|,\\d+\\)$', '', ggcumev.facet.vacschedule.ply$x$data[[n_facet+1]]$name))
    for (i in (n_facet+2):(2*n_facet)) {
      ggcumev.facet.vacschedule.ply$x$data[[i]]$showlegend <- FALSE
    }
...
tryCatch(
  {
    # Main analysis
    write.xlsx(
      surv_summary(surv_fit), file = paste0('results-survival-analysis-',country,'.xlsx'), sheetName = c("Surv_summary"), row.names = FALSE) 
    write.xlsx(
      df_sum_cph, file = paste0('results-survival-analysis-',country,'.xlsx'), sheetName = c("HR"), append=TRUE, row.names = TRUE) 
    write.xlsx(
      df_rmst_result, file = paste0('results-survival-analysis-',country,'.xlsx'), sheetName = c("RMST_RMTL"), append=TRUE, row.names = FALSE)
    write.xlsx(
      df_rmst_contrast, file = paste0('results-survival-analysis-',country,'.xlsx'), sheetName = c("ATE"), append=TRUE, row.names = FALSE)
    
    # Subgroup analysis - vaccination schedule
    write.xlsx(
      surv_summary(surv_fit_vacschedule), file = paste0('results-survival-analysis-',country,'.xlsx'), sheetName = c("Surv_summary_vacschedule"),  append=TRUE, row.names = FALSE)
    write.xlsx(
      df_sum_cph_subg_vacschedule, file = paste0('results-survival-analysis-',country,'.xlsx'), sheetName = c("HR_vacschedule"), append=TRUE, row.names = TRUE) 
    write.xlsx(
      df_rmst_result_vacschedule, file = paste0('results-survival-analysis-',country,'.xlsx'), sheetName = c("RMST_RMTL_vacschedule"), append=TRUE, row.names = FALSE)
    write.xlsx(
      df_rmst_contrast_vacschedule, file = paste0('results-survival-analysis-',country,'.xlsx'), sheetName = c("ATE_vacschedule"), append=TRUE, row.names = FALSE)
