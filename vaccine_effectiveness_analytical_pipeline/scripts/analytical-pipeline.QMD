...
if(FALSE) {
  ...
  authors     <- list('Javier González-Galindo', 'Santiago Royo-Sierra', 'Francisco Estupiñán-Romero', 'Marjan Meurisse', 'Nina Van Goethem', 'Enrique Bernal-Delgado')
  version    <- '1.0.0'
...
```{r, EDA, message=FALSE, warning=FALSE, error=FALSE}

# 2. Specific Exploratory Data Analysis (EDA)
